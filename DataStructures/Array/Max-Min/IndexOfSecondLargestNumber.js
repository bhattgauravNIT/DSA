/**Given an array find index of second largest elemnet in array if there is no second largest return -1
 * 
 * Ex: arr = [11,9,0,12,8] O/p is 11
 *     arr = [10,10,10] O/p is -1
 *     arr = [11,11,9,8,10] O/p is 4
 */

/**O(n),O(1) 
 * 
 * In the first iteration find the max elemnet from the array.
