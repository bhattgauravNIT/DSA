 ...
 * 
    * So we can cut the rope in 2 pieces such that one peice is of length 11 and the other is 12.
 ...
 * 
    * 1. We can cut the rope in 2 peices of 2 and 1 peice of 1. Here the smaller ropes made are 3. -> 3
    * 2. We can have a single smaller rope of length 5 as we can cut in length 5.  -> 1
    * 3. We can cut the rope in 5 peices each of length 1. -> 5
    * 
...
/**Appraoch 1
 * 
 * The possible max smaller rope peices for rope of length 23 with possible cuts as 11,9 and 12 , will be length 2 , one peice of 
 * 11 and other of 12.
 * 
 * Say we have a rope of length 23 which can be cutted into peices of length 11, 9 or 12.
 ...
 * 
 * 
 * if n beomes 0 return 0, if n becomes negative return -1. If n is zero that means its a succesful cut and result in peices + 1 where
 * initially peices is 0 else wise its an unsuccessful cut.
 * 
